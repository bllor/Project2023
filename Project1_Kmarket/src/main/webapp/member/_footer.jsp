<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8"%>
    <footer>
      <ul>
        ...
        <li>
          <a href="/kMarket/member/signup.do">서비스이용약관</a>
        </li>
        <li>
          <a href="/kMarket/member/signup.do">개인정보처리방침</a>
        </li>
        <li>
          <a href="/kMarket/member/signup.do">전자금융거래약관</a>
        </li>
      </ul>
      <div>
        <p>
          <img src="/kMarket/member/image/footer_logo.png" alt="푸터 로고" />
        </p>
        <p>
