				...
				<c:forEach var="cart" items="${carts}">
					<tr>
						<td>
							...
							<input type="text" name="prodNo" value="${cart.prodNo }">
							<input type="text" name="prodName" value="${cart.prodName }">
							<input type="text" name="descript" value="${cart.descript }">
							<input type="text" name="thumb2" value="${cart.thumb2 }">
