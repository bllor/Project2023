...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/kMarket/index_css/common.css" />
      ...
      <header>
        ...
        <div class="menu">
          <div>
            ...
            <ul>
              <li><a href="/kMarket/cs/board/list.do?cate=notice&menu1=전체보기">공지사항</a></li>
              <li><a href="/kMarket/cs/board/list.do?cate=faq&menu1=회원">자주묻는질문</a></li>
              <li><a href="/kMarket/cs/board/list.do?cate=qna&menu1=전체보기">문의하기</a></li>
