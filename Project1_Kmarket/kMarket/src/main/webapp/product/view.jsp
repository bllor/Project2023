                ...
                <article class="info">
                    ...
                    <div class="summary">
                        ...
                        <form id="sendForm" action="#" method="post">
                        	<input type="hidden" name="uid" value="aaa1"><!-- value값에 ${sessUser.uid}넣어주기 -->
                        	<input type="hidden" name="prodNo" value="${product.prodNo}">
                        	<input type="hidden" name="prodName" value="${product.prodName}">
                        	<input type="hidden" name="descript" value="${product.descript}">
                        	<input type="hidden" name="price" value="${product.price}"> <!-- ori-price -->
		                	<input type="hidden" name="num" value="1">
		                	<input type="hidden" name="total" value=""> <!-- ori-price랑 discount 가격 계산한것 -->
		                	<input type="hidden" name="discount" value="${product.discount }">                
		                	<input type="hidden" name="point" value="${product.point }">                
		                	<input type="hidden" name="delivery" value="${product.delivery}">
		                	<input type="hidden" name="final" value=""> <!-- total가격 + delivery가격 --> 
		                	<input type="hidden" name="thumb2" value="${product.thumb2 }"> <!-- total가격 + delivery가격 --> 
                        </form>
                        <div class="button">
