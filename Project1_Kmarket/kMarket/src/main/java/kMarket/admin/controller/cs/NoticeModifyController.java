...
public class NoticeModifyController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (isUpdated) {
                resp.sendRedirect("/kMarket/admin/cs/notice/detail.do?cNo=" + req.getParameter("cNo"));
            }else{
                resp.sendRedirect("/kMarket/admin/cs/notice/modify.do?cNo="+req.getParameter("cNo"));
            }
